<template>
    <div>
        <the-title title="Position Tags - Categories">
            <router-link :to="{name: 'create-positionTagCategory'}">
                <v-button-create title="Create Position Tag Category"></v-button-create>
            </router-link>
        </the-title>
        <b-row>
            <b-col cols="12">
