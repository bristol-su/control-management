...
<script> 
    ...
    export default {
        ...
        mounted() {
            this.$control.positionTagCategory().get(this.$route.params.positionTagCategoryId)
                .then(response => this.category = response.data)
                .catch(error => this.$notify.alert('Could not load the position tag category: ' + error.message));
        },
